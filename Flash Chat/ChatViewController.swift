...
class ChatViewController: UIViewController, UITableViewDelegate, UITextFieldDelegate, UITableViewDataSource {
    ...
    var messageArray: [Message] = [Message]()  //create array of Message object
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //differentiate user with different chat colour
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        UIView.animate(withDuration: 0.5) {
            ...
            self.view.layoutIfNeeded()  //if constraint chnaged, chnage the whole thing
    ...
    @IBAction func logOutPressed(_ sender: AnyObject) {
        ...
        do {
            ...
            print("Theres was a problem signing out")
        }
